...
def clipping(projection, faces):
    graph_after_cohen = []
    for face in faces:
        p1 = np.array([projection[face[0]][0], projection[face[0]][1], projection[face[0]][2]])
        p2 = np.array([projection[face[1]][0], projection[face[1]][1], projection[face[1]][2]])
        p3 = np.array([projection[face[2]][0], projection[face[2]][1], projection[face[2]][2]])
